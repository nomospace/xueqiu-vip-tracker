          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <button 
                ...
                [disabled]="refreshing"
                class="flex items-center justify-center w-10 h-10 bg-white/10 hover:bg-white/20 rounded-lg text-sm transition disabled:opacity-50"
                title="刷新">
      ...
      <main class="max-w-7xl mx-auto px-4 py-4 space-y-4">
        @if (loading) {
          ...
          <div class="p-8 text-center">
            ...
            <p class="text-slate-400">{{ selectedDate }} 暂无摘要数据</p>
            <p class="text-xs text-slate-300 mt-2">该日期没有大V发言或数据未同步，试试其他日期</p>
          </div>
        } @else {
          <!-- ========== 核心数据看板（横向滚动卡片） ========== -->
